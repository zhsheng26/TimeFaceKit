    ...
    public static ErrorViewContent getContentObj(int state) {
        ...
        switch (state) {
            ...
            case HttpStatusCodes.NO_CONNECT:
                return new ErrorViewContent(state, R.drawable.state_error, title, null, R.string.state_btn_retry, 0);
            case HttpStatusCodes.NO_MORE_INFO:
                return new ErrorViewContent(state, R.drawable.state_error, title, null, 0, 0);
            case HttpStatusCodes.NO_MORE_DATA:
                return new ErrorViewContent(state, R.drawable.state_error, title, null, 0, 0);
            case HttpStatusCodes.GET_ALL_MESSAGE:
                return new ErrorViewContent(state, R.drawable.state_get_all_time, title, null, 0, 0);
