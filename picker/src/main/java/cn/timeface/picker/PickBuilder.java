...
/**
 * Entry for PickBuilder's media selection.
 */
public final class PickBuilder {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private PickBuilder(Activity activity) {
        this(activity, null);
    }

    private PickBuilder(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private PickBuilder(Activity activity, Fragment fragment) {
        mContext = new WeakReference<>(activity);
        mFragment = new WeakReference<>(fragment);
    }

    /**
     * Start PickBuilder from an Activity.
     * <p>
     * This Activity's {@link Activity#onActivityResult(int, int, Intent)} will be called when user
     * finishes selecting.
     *
     * @param activity Activity instance.
     * @return PickBuilder instance.
     */
    public static PickBuilder from(Activity activity) {
        return new PickBuilder(activity);
    }

    /**
     * Start PickBuilder from a Fragment.
     * <p>
     ...
     * @return PickBuilder instance.
     */
    public static PickBuilder from(Fragment fragment) {
        return new PickBuilder(fragment);
    }
    ...
    public static List<Uri> obtainResult(Intent data) {
        return data.getParcelableArrayListExtra(PickActivity.EXTRA_RESULT_SELECTION);
    }
