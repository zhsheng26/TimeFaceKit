...
import cn.timeface.picker.engine.ImageEngine;
import cn.timeface.picker.filter.Filter;
import cn.timeface.picker.internal.entity.CaptureStrategy;
import cn.timeface.picker.internal.entity.SelectionSpec;
import cn.timeface.picker.ui.PickActivity;
...
import cn.timeface.picker.engine.impl.GlideEngine;
import cn.timeface.picker.engine.impl.PicassoEngine;
...
public final class SelectionCreator {
    private final PickBuilder mPickBuilder;
     ...
     *
     * @param pickBuilder  a requester context wrapper.
     * @param mimeTypes MIME type set to select.
     */
    SelectionCreator(PickBuilder pickBuilder, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
    ...
    public void forResult(int requestCode) {
        Activity activity = mPickBuilder.getActivity();
        if (activity == null) {
            return;
        }
        ...
        Fragment fragment = mPickBuilder.getFragment();
        if (fragment != null) {
